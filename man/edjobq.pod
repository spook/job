...
edjobq - Edit (change) job queue attributes

=head1 SYNOPSIS

edjobq [I<options>] I<queue_name>
...
=head1 EXAMPLES
 ...
 edjobq -d "For daily project builds"  builds

 edjobq -t 500 financials

=head1 SEE ALSO

job(7), job.conf(5), lsjobq(8), mkjobq(8), rmjobq(8), edjob(8), lsjob(8), mkjob(8), rmjob(8), jobman(8)
