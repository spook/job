...
If the queues are part of a cluster or distribute environment, the job may start on 
...
This package contains commands to manage your job queues:
...
An optional description may also be given for the queue; this is a sentence or so 
...
A job file; stored in one of the C</var/spool/job/I<queue_name>/I<job_state>/>
